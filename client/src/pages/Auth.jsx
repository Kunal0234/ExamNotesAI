  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white text-black px-8">
      <motion.header
        ...
        className="max-w-7xl mx-auto mt-8 rounded-2xl bg-black/80 backdroup-blur-xl border border-white/10 px-8 py-6 shadow-[0_20px_45px_rgba(0,0,0,0.6)]"
      >
      ...
      <main className="max-w-7xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 ">
          ...
          <Feature
            icon="📂"
            title="Project Notes"
            des="Well-structed documentation for assignments & projects"
          />
          <Feature
            icon="📊"
            title="Charts & Graphs"
